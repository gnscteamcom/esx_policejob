Locales['en'] = {
  ...
  ['no_outfit'] = 'there are no uniform that fit you!',
  ...
  ['garage_blocked'] = 'there are no available spawn points!',
  ...
  ['service_not'] = 'you have not entered service! You will have to get changed first.',
  ['service_anonunce'] = 'service information',
  ['service_in'] = 'you\'ve entered service, welcome!',
  ['service_in_announce'] = 'officer %s has entered service!',
  ['service_out'] = 'you have left service.',
  ['service_out_announce'] = 'officer %s has left their service.',
  -- Action Menu
  ...
  ['no_vehicles_nearby'] = 'there is no vehicle(s) nearby',
